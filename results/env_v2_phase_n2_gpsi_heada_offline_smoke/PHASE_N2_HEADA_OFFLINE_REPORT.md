...
- Delta-only test MSE: `0.184110`
- NLL model test MSE: `0.185981`
- NLL model test Gaussian NLL: `-0.813544`
- Mean nonlinear test MSE improvement over zero: `0.3473`

## Projected Uncertainty Calibration

- Mean corr(projected_std, |projected_error|) over test radial/relative-velocity directions: `-0.0163`
...
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/delta_loss_curve.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/nll_loss_curve.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/per_horizon_mse_bar.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/per_motion_mode_error_bar.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/logvar_by_motion_mode.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/projected_uncertainty_reliability.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/zscore_histogram.png`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/plots/predicted_vs_error_scatter.png`
...
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/tables`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/logs/phase_n2_train_delta_only.log`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/logs/phase_n2_train_nll.log`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/logs/phase_n2_eval.log`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/phase_n2_watcher.log`
- `results/env_v2_phase_n2_gpsi_heada_offline_smoke/PHASE_N2_HEADA_OFFLINE_COMPLETE.flag`
