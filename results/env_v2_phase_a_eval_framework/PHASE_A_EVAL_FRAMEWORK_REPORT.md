...
- `results/env_v2_phase_a_eval_framework/` result artifacts
...
- scenarios: `eval_flow_id, eval_flow_high_speed`
- policies: `random, straight_line, cpa_reactive, attention_full, filtered_attention_full`
- episodes per scenario-policy: `3`
- checkpoint: `checkpoints/env_v2_phase2/attention_full_s0/attention_full_s0_step1500000.zip`

| policy | scenario | episodes | success | collision | near_miss | mean_min_distance | filter_rate |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| attention_full | eval_flow_high_speed | 3 | 0.6667 | 0.3333 | 0.6667 | 4.2862 | 0.0000 |
| attention_full | eval_flow_id | 3 | 0.3333 | 0.6667 | 0.3333 | 5.4474 | 0.0000 |
| cpa_reactive | eval_flow_high_speed | 3 | 0.3333 | 0.0000 | 0.6667 | 3.4843 | 0.0000 |
| cpa_reactive | eval_flow_id | 3 | 0.0000 | 0.0000 | 0.3333 | 3.4762 | 0.0000 |
| filtered_attention_full | eval_flow_high_speed | 3 | 0.0000 | 1.0000 | 0.0000 | 3.5315 | 0.8984 |
| filtered_attention_full | eval_flow_id | 3 | 0.6667 | 0.3333 | 0.3333 | 4.0930 | 0.8240 |
| random | eval_flow_high_speed | 3 | 0.0000 | 0.0000 | 0.0000 | 5.7451 | 0.0000 |
| random | eval_flow_id | 3 | 0.0000 | 0.0000 | 0.0000 | 8.1908 | 0.0000 |
| straight_line | eval_flow_high_speed | 3 | 0.0000 | 1.0000 | 0.0000 | 4.0050 | 0.0000 |
| straight_line | eval_flow_id | 3 | 0.0000 | 1.0000 | 0.0000 | 4.6285 | 0.0000 |
